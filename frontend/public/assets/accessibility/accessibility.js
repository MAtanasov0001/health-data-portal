...
// Добавено при интегрирането: top-level `const` не се закача на window, а React-обвивката
// (afterInteractive) проверява първо `window.accessibility`. Излагаме го явно, за да е надеждно.
