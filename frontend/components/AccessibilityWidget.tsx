...
// Вградена приставка за достъпност (Информационно обслужване АД), взета от платформата sigma и
// поставена под public/assets/accessibility/. Скриптът е чужд (vendored) — този wrapper само го
// инициализира и инсталира „оцеляваща" CSS, така че лентата да остане използваема в текстов режим,
// когато всички останали стилове се изключват. Не форкваме самия скрипт.
...
html.a11y-textonly .skip-link:not(:focus){position:absolute!important;left:-9999px!important;top:-9999px!important;width:1px!important;height:1px!important;overflow:hidden!important}
html.a11y-textonly img,html.a11y-textonly svg,html.a11y-textonly video{display:none!important}
html.a11y-textonly .a11y-tools__button{display:none!important}
...
html.a11y-textonly .a11y-tools__nav{margin:0!important;width:auto!important}
...
html.a11y-textonly .site{border-bottom:1px solid #bbb!important;padding-bottom:10px!important;margin-bottom:16px!important}
html.a11y-textonly .brand{display:inline-block!important;margin-bottom:6px!important;text-decoration:none!important}
html.a11y-textonly .primary ul{display:flex!important;flex-wrap:wrap!important;gap:6px 20px!important;margin:8px 0!important;padding:0!important;list-style:none!important}
html.a11y-textonly .primary a{display:inline-block!important;padding:2px 0!important}
...
export default function AccessibilityWidget({ lang }: { lang: string }) {
  useEffect(() => {
    let stopped = false;
